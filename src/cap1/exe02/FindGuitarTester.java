...
public class FindGuitarTester {
	...
	public static void main(String[] args) {
		...
		if ( matchingGuitars != null ) {
			...
			System.out.println("  We have a " + matchingGuitars.getBuilder() + " " + matchingGuitars.getModel() + " "
						+ matchingGuitars.getType() + " guitar:\n     " + matchingGuitars.getBackWood() + " back and sides,\n     "
						+ matchingGuitars.getTopWood() + " top.\n  You can have it for only $" + matchingGuitars.getPrice()
						+ "!\n  ----");
